...
export default function Services() {
  return (
    <section className="w-full py-16 px-4 sm:px-8 lg:px-16 space-y-8">
      ...
      <div className="bg-neutral-900 text-neutral-200 p-6 rounded-md max-w-2xl space-y-4 transition-transform duration-200 hover:-translate-y-1 hover:shadow-lg">
        ...
        <button className="bg-yellow-500 text-black py-2 px-6 rounded-md font-semibold transition duration-150 hover:bg-yellow-400 cursor-pointer">
          Get a Quote
        </button>
      </div>
